...
<article class="my-5 offset-lg-1 col-lg-9">

    <div class="tittle_post row">
      <img class="icon_tittle" src="zressources/images/ancre_project.png" alt="ancre">
      <h3 id="projects">Mes Projets</h3>
    </div>
    <div class="my-5 row">
        <div class="col-lg-4">
    ...
    <div class="my-5 row">
        ...
        <div class="col-8">
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="navire" role="tabpanel" aria-labelledby="list-navire">navire</div>
    ...
    <div class="my-5 row">
      ...
      <div class="col-8">
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="lebanon" role="tabpanel" aria-labelledby="list-lebanon">lebanon</div>
